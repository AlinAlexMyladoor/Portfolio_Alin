...
import { SiExpress, SiSpringboot, SiRender, SiVite, SiSqlite } from "react-icons/si";
...
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "SQLite", icon: SiSqlite, url: "https://sqlite.org" },
  ],
];
              ...
              {row.map((tech, techIndex) => (
                ...
                >
                  {typeof tech.icon === 'string' ? (
                    ...
                    <tech.icon className="techstack-react-icon" />
                  )}
                  <span>{tech.name}</span>
                </a>
              ))}
